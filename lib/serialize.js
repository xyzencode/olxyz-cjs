...
const { jidNormalizedUser, extractMessageContent, areJidsSameUser, downloadMediaMessage, proto, generateWAMessageFromContent, generateWAMessage, prepareWAMessageMedia } = require("@xyzendev/baileys")
const { parsePhoneNumber } = require("libphonenumber-js");
const { fileTypeFromBuffer } = require("file-type");
const { escapeRegExp } = require("./functions.js");

async function appenTextMessage(text, originalMsg, m, client) {
 ...
 * @return {*} 
 */
async function smsg(client, msg, store) {
    try {
        const m = {};
